...
@NamedQueries({
    ...
    , @NamedQuery(name = "Ordentrabajo.findByOrdtrHaymat", query = "SELECT o FROM Ordentrabajo o WHERE o.ordtrHaymat = :ordtrHaymat")})
public class Ordentrabajo implements Serializable {
    ...
    @Column(name = "ordtr_haymat")
    private Boolean ordtrHaymat;
    ...
    public Boolean getOrdtrHaymat() {
        return ordtrHaymat;
    }

    public void setOrdtrHaymat(Boolean ordtrHaymat) {
        this.ordtrHaymat = ordtrHaymat;
    }

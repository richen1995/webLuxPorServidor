...
public class Ventaprevia implements Serializable {
    ...
    private Date vntpFecha;
    @Column(name = "vntp_hora")
    @Temporal(TemporalType.TIME)
    private Date vntpHora;
    ...
    public Date getVntpFecha() {
        return vntpFecha;
    }

    public void setVntpFecha(Date vntpFecha) {
        this.vntpFecha = vntpFecha;
    }
    
    public Date getVntpHora() {
        return vntpHora;
    }

    public void setVntpHora(Date vntpHora) {

...
public class Actividad implements Serializable {
    ...
    private String actHorainicial;
    @Column(name = "act_horafinal")
    //@Temporal(TemporalType.TIME)
    private String actHorafinal;
    ...
    public String getActHorainicial() {
        return actHorainicial;
    }

    public void setActHorainicial(String actHorainicial) {
        this.actHorainicial = actHorainicial;
    }

    public String getActHorafinal() {
        return actHorafinal;
    }

    public void setActHorafinal(String actHorafinal) {
